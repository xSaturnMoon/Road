...
class SigningEngine {
    ...
    static func sign(ipaURL: URL, metadata: IPAMetadata, session: AppleSession, progress: @escaping (Double, String) -> Void) async throws -> SignedPackage {
        ...
        let workDir = fileManager.temporaryDirectory.appendingPathComponent("Bloom_sign_\(UUID().uuidString)")
...
<dict>
    <key>AppIDName</key>
    <string>Bloom Sideload</string>
    <key>ApplicationIdentifierPrefix</key>
    <array><string>Bloom</string></array>
    ...
    <key>Name</key>
    <string>Bloom Development</string>
